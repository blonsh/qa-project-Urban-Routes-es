...
class UrbanRoutesPage(BasePage):
    ...
    COMFORT = (By.XPATH, "//div[text()='Comfort']")  # Selector más robusto para Comfort

    PHONE_BUTTON = (By.CLASS_NAME, "np-text")
    PHONE_INPUT = (By.ID, "phone")
    CODE_INPUT = (By.ID, "code")
    CONFIRM_PHONE = (By.XPATH, "//button[text()='Siguiente']")  # Para el modal de tel
    ...
    ADD_CARD_SUBMIT = (By.XPATH, "//button[text()='Enlazar']")
    ...
    def add_card(self, number, cvv):
        ...
        # Enviar CVV y presionar TAB para habilitar el botón "Enlazar"
